...
#include "LerpTable.hpp"  // NOLINT(build/include_order)

#include <gtest/gtest.h>
#include <units/angular_velocity.h>
#include <units/length.h>

TEST(LerpTableTest, Insert) {
    frc3512::LerpTable<units::meter_t, units::radians_per_second_t> table;
