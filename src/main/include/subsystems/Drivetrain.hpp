...
private:
    ...
    frc::LinearSystem<2, 2, 2> m_imfRef =
        frc::LinearSystemId::IdentifyDrivetrainSystem(
            DrivetrainTrajectoryController::kLinearV,
            DrivetrainTrajectoryController::kLinearA * 5.0,
            DrivetrainTrajectoryController::kAngularV,
            DrivetrainTrajectoryController::kAngularA * 2.0);
    ...
    frc::sim::DifferentialDrivetrainSim m_drivetrainSim{
        ...
        DrivetrainTrajectoryController::kWidth, frc::DCMotor::NEO(2),
        DrivetrainTrajectoryController::kDriveGearRatio,
        DrivetrainTrajectoryController::kWheelRadius};
